...
{
    /// <inheritdoc />
    public partial class AddStatusAndPriorityToTicket : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagTicket", x => new { x.TagsTagId, x.TicketsTicketId });
                    table.ForeignKey(
                        name: "FK_TagTicket_Tags_TagsTagId",
                        column: x => x.TagsTagId,
                        principalTable: "Tags",
                        principalColumn: "TagId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagTicket_Tickets_TicketsTicketId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagTicket_TicketsTicketId",
                table: "TagTicket",
