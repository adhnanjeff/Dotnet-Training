...
namespace BugTrack.Application.Services
{
    public class BugService : IBugService
    {
        ...
        //public List<BugRequestDTO> GetBugsByStatus(string status)
        //{
        //    var bugs = _context.Bugs.Where(b => b.Status.Equals(status, StringComparison.OrdinalIgnoreCase)).ToList();
        //    return bugs.Select(b => new BugRequestDTO
        //    {
        //        Title = b.Title,
        //        Description = b.Description,
