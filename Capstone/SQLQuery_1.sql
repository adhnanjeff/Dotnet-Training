...
VALUES 
('Admin', 'ADMIN');
DELETE FROM AspNetRoles WHERE Id = 3;
...
UPDATE AspNetUsers SET Email = 'akash.2211005@srec.ac.in' WHERE Id = 19;
UPDATE AspNetUsers SET NormalizedEmail = 'AKASH.2211005@SREC.AC.IN' WHERE Id = 19;
UPDATE AspNetUsers SET ManagerId = '35' WHERE Id = 31;
UPDATE AspNetUsers SET NormalizedUserName = 'PRADEEP' WHERE Id = 20;
select * from AspNetUsers;
UPDATE AspNetUsers SET ManagerId = 17 WHERE Role = 0;
...
INSERT INTO MeetingRooms (RoomName, Capacity, Amenities)
VALUES 
('Kabini', 4, 'Whiteboard, Projector'),
('Mahanadi', 6, 'Whiteboard, Projector, Conference Phone'),
('Brahmaputra', 10, 'Whiteboard, Projector, Conference Phone, Video Conferencing'),
('Godavari', 6, 'Whiteboard, Projector, Conference Phone'),
('Indus', 6, 'Whiteboard, Projector, Conference Phone'),
('Ganges', 11, 'Whiteboard, Projector, Video Conferencing, Conference Phone, Air Conditioning'),
('Krishna', 8, 'Whiteboard, Projector, Conference Phone'),
('Periyar', 6, 'Whiteboard, Projector'),
('Yamuna', 4, 'Whiteboard, Projector'),
('Penna', 2, 'Whiteboard'),
('Kaveri', 5, 'Whiteboard, Projector'),
('Pamba', 2, 'Whiteboard');
